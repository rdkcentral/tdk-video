...
class DSHalAgent : public RDKTestStubInterface , public AbstractServer<DSHalAgent>
{
        public:
		    ...
		    this->bindAndAddMethod(Procedure("TestMgr_DSHal_SetFPBrightness", PARAMS_BY_NAME, JSON_STRING,"indicator",JSON_INTEGER,"brightness",JSON_INTEGER,NULL), &DSHalAgent::DSHal_SetFPBrightness);
                    ...
                    this->bindAndAddMethod(Procedure("TestMgr_DSHal_IsSurroundDecoderEnabled", PARAMS_BY_NAME, JSON_STRING, "Isnullparamcheck", JSON_INTEGER, "IsHandleInvalid", JSON_INTEGER, "paramhandle", JSON_INTEGER, NULL), &DSHalAgent::DSHal_IsSurroundDecoderEnabled);
                    this->bindAndAddMethod(Procedure("TestMgr_DSHal_EnableSurroundDecoder", PARAMS_BY_NAME, JSON_STRING, "enable", JSON_INTEGER, "IsHandleInvalid", JSON_INTEGER, "paramhandle", JSON_INTEGER, NULL), &DSHalAgent::DSHal_EnableSurroundDecoder);
                    this->bindAndAddMethod(Procedure("TestMgr_DSHal_GetMS12Capabilities", PARAMS_BY_NAME, JSON_STRING, "Isnullparamcheck", JSON_INTEGER, "IsHandleInvalid", JSON_INTEGER, "paramhandle", JSON_INTEGER, NULL), &DSHalAgent::DSHal_GetMS12Capabilities);
                    this->bindAndAddMethod(Procedure("TestMgr_DSHal_GetMISteering", PARAMS_BY_NAME, JSON_STRING, "Isnullparamcheck", JSON_INTEGER, "IsHandleInvalid", JSON_INTEGER, "paramhandle", JSON_INTEGER, NULL), &DSHalAgent::DSHal_GetMISteering);
                    this->bindAndAddMethod(Procedure("TestMgr_DSHal_SetMISteering", PARAMS_BY_NAME, JSON_STRING, "enable", JSON_INTEGER, "IsHandleInvalid", JSON_INTEGER, "paramhandle", JSON_INTEGER, NULL), &DSHalAgent::DSHal_SetMISteering);
                    this->bindAndAddMethod(Procedure("TestMgr_DSHal_GetMS12AudioProfileList", PARAMS_BY_NAME, JSON_STRING, "Isnullparamcheck", JSON_INTEGER, "IsHandleInvalid", JSON_INTEGER, "paramhandle", JSON_INTEGER, NULL), &DSHalAgent::DSHal_GetMS12AudioProfileList);
                    ...
                    this->bindAndAddMethod(Procedure("TestMgr_DSHal_AudioEnableARC", PARAMS_BY_NAME, JSON_STRING, "ARCType", JSON_INTEGER, "enable", JSON_INTEGER, "IsHandleInvalid", JSON_INTEGER, "paramhandle", JSON_INTEGER, NULL), &DSHalAgent::DSHal_AudioEnableARC);
                    this->bindAndAddMethod(Procedure("TestMgr_DSHal_GetStereoAuto", PARAMS_BY_NAME, JSON_STRING, "Isnullparamcheck", JSON_INTEGER, "IsHandleInvalid", JSON_INTEGER, "paramhandle", JSON_INTEGER, NULL), &DSHalAgent::DSHal_GetStereoAuto);
                    this->bindAndAddMethod(Procedure("TestMgr_DSHal_SetStereoAuto", PARAMS_BY_NAME, JSON_STRING, "automode", JSON_INTEGER, "IsHandleInvalid", JSON_INTEGER, "paramhandle", JSON_INTEGER, NULL), &DSHalAgent::DSHal_SetStereoAuto);
                    this->bindAndAddMethod(Procedure("TestMgr_DSHal_GetAudioGain", PARAMS_BY_NAME, JSON_STRING, "Isnullparamcheck", JSON_INTEGER, "IsHandleInvalid", JSON_INTEGER, "paramhandle", JSON_INTEGER, NULL), &DSHalAgent::DSHal_GetAudioGain);
                    this->bindAndAddMethod(Procedure("TestMgr_DSHal_SetAudioGain", PARAMS_BY_NAME, JSON_STRING, "audiogain", JSON_INTEGER, "IsHandleInvalid", JSON_INTEGER, "paramhandle", JSON_INTEGER, NULL), &DSHalAgent::DSHal_SetAudioGain);
                    this->bindAndAddMethod(Procedure("TestMgr_DSHal_GetAudioDB", PARAMS_BY_NAME, JSON_STRING, "Isnullparamcheck", JSON_INTEGER, "IsHandleInvalid", JSON_INTEGER, "paramhandle", JSON_INTEGER, NULL), &DSHalAgent::DSHal_GetAudioDB);
                    ...
                    this->bindAndAddMethod(Procedure("TestMgr_DSHal_SetAudioMixerLevels", PARAMS_BY_NAME, JSON_STRING, "AudioInput", JSON_INTEGER, "audiolevel", JSON_INTEGER, "IsHandleInvalid", JSON_INTEGER, "paramhandle", JSON_INTEGER, NULL), &DSHalAgent::DSHal_SetAudioMixerLevels);
                    this->bindAndAddMethod(Procedure("TestMgr_DSHal_SetMS12AudioProfile", PARAMS_BY_NAME, JSON_STRING, "Isnullparamcheck", JSON_INTEGER, "IsHandleInvalid", JSON_INTEGER, "audioprofile", JSON_STRING, "paramhandle", JSON_INTEGER, NULL), &DSHalAgent::DSHal_SetMS12AudioProfile);
                    this->bindAndAddMethod(Procedure("TestMgr_DSHal_SetAudioEncoding", PARAMS_BY_NAME, JSON_STRING, "encoding", JSON_INTEGER, "IsHandleInvalid", JSON_INTEGER, "paramhandle", JSON_INTEGER, NULL), &DSHalAgent::DSHal_SetAudioEncoding);
                }
                ...
                void DSHal_IsSurroundDecoderEnabled(IN const Json::Value& req, OUT Json::Value& response);
                void DSHal_EnableSurroundDecoder(IN const Json::Value& req, OUT Json::Value& response);
                void DSHal_GetMS12Capabilities(IN const Json::Value& req, OUT Json::Value& response);
                void DSHal_GetMISteering(IN const Json::Value& req, OUT Json::Value& response);
                void DSHal_SetMISteering(IN const Json::Value& req, OUT Json::Value& response);
                void DSHal_GetMS12AudioProfileList(IN const Json::Value& req, OUT Json::Value& response);
                ...
                void DSHal_AudioEnableARC(IN const Json::Value& req, OUT Json::Value& response);
                void DSHal_GetStereoAuto(IN const Json::Value& req, OUT Json::Value& response);
                void DSHal_SetStereoAuto(IN const Json::Value& req, OUT Json::Value& response);
                void DSHal_GetAudioGain(IN const Json::Value& req, OUT Json::Value& response);
                void DSHal_SetAudioGain(IN const Json::Value& req, OUT Json::Value& response);
                void DSHal_GetAudioDB(IN const Json::Value& req, OUT Json::Value& response);
                ...
                void DSHal_SetMS12AudioProfile(IN const Json::Value& req, OUT Json::Value& response);
                void DSHal_SetAudioMixerLevels(IN const Json::Value& req, OUT Json::Value& response);
                void DSHal_SetAudioEncoding(IN const Json::Value& req, OUT Json::Value& response);
};
